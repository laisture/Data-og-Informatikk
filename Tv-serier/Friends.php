<?php
	...
	$name1 = "Phillip,"; // Here goes the name of the the first person who wrote a review.

	$date1 = "03 Oct 2014"; // Here goes the date of the first review.
	...
	$date2 = "12 Sept 2014"; // Here goes the date of the second review.
