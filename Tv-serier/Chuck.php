<?php
	...
	$name1 = "Bjarne"; // Here goes the name of the the first person who wrote a review.

	$date1 = "May 25 2011"; // Here goes the date of the first review.
	...
	$date2 = "Dec 21 2013"; // Here goes the date of the second review.
