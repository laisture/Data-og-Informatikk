<?php
	...
	$name1 = "Andreas,"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Dec 3 2010"; // Here goes the date of the first review.
	...
	$date2 = "Apr 2 2012"; // Here goes the date of the second review.
