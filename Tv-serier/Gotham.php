<?php
	...
	$name1 = "Einar"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Sep 25 2014"; // Here goes the date of the first review.
	...
	$date2 = "Oct 11 2014"; // Here goes the date of the second review.
