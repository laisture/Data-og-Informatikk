<?php
	...
	$name1 = "Elin"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Sep 13 2013"; // Here goes the date of the first review.
...
I'd recommend it, It's a pretty good show and I don't see how people can hate it let alone give it a negative review."; // Here goes the first review text.
	...
	$date2 = "Jan 10 2013"; // Here goes the date of the second review.
