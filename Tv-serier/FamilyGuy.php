<?php
	...
	$name1 = "Bart"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Nov 17 2010"; // Here goes the date of the first review.
	...
	$date2 = "May 21 2014"; // Here goes the date of the second review.
