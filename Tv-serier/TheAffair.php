<?php
	...
	$name1 = "Niklaus,"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Oct 31 2014"; // Here goes the date of the first review.
	...
	$date2 = "Oct 15 2014"; // Here goes the date of the second review.
