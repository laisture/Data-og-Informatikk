<?php
	...
	$name1 = "Lars"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Jan 10 2011"; // Here goes the date of the first review.
	...
	$date2 = "Sep 21 2012"; // Here goes the date of the second review.
