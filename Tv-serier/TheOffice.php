<?php
	...
	$name1 = "Vigdis"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Aug 6 2012"; // Here goes the date of the first review.
	...
	$date2 = "Oct 7 2012"; // Here goes the date of the second review.
