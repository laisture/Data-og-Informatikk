<?php
	...
	$name1 = "Camilla"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Aug 8 2011"; // Here goes the date of the first review.
	...
	$date2 = "Apr 21 2011"; // Here goes the date of the second review.
