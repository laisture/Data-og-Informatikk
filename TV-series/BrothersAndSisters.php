<?php
	...
	$name1 = "Josefine"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Oct 28 2008"; // Here goes the date of the first review.
	...
	$date2 = "May 22 2007"; // Here goes the date of the second review.
