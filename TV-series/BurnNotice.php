<?php
	...
	$name1 = "Nils"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Mar 18 2009"; // Here goes the date of the first review.
	...
	$date2 = "Mar 15 2011"; // Here goes the date of the second review.
