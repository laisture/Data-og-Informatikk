<?php
	...
	$title = "Dexter"; // Here goes the title of the tv-serie.
	...
	$poster ="../Pictures/Dexter.jpg"; // Here goes the url for the poster of the tv-serie.
	...
	$review1 = "Best...Show...Ever! After the first five minutes into Season One, I've been hooked. I've even got my dad addicted to this. I'm venturing to say this is better than The Simpsons."; // Here goes the first review text.
