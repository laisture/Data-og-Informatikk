<?php
	...
	$name1 = "Andrea"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Sep 25 2013"; // Here goes the date of the first review.
	...
	$date2 = "Jul 9 2014"; // Here goes the date of the second review.
