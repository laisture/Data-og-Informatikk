<?php
	...
	$name1 = "Isabella"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Nov 3 2010"; // Here goes the date of the first review.
	...
	$date2 = "Dec 5 2008"; // Here goes the date of the second review.
