<?php
	...
	$name1 = "Anita"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Mar 20 2014"; // Here goes the date of the first review.
	...
	$date2 = "Jul 4 2013"; // Here goes the date of the second review.
