<?php
	...
	$title = "Doctor Who"; // Here goes the title of the tv-serie.
	...
	$name1 = "Melissa"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Aug 24 2011"; // Here goes the date of the first review.
	...
	$review2 = "As an American, British TV was irrelevant to me. That was until I stumbled on this masterpiece. About one year ago I discovered the TV show and soon watched every episode, eventually reaching Season 6, which I loved. If you are a fan of Sci-fi or just very intellectual story-telling, check this show out."; // Here goes the second review text.
