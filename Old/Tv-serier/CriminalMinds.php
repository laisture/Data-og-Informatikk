<?php
	...
	$name1 = "Erik"; // Here goes the name of the the first person who wrote a review.

	$date1 = "Jan 3 2011"; // Here goes the date of the first review.
	...
	$date2 = "Feb 7 2007"; // Here goes the date of the second review.
